...
PARAMETER_SECTION
 //growth pars
  ...
  init_bounded_number deltaf(5.0,150.0,growth_phase2)
 ...
 // three survey eras:
  //srv1: 1978-1982
   ...
   init_bounded_vector srv3_q(1988,endyr,0.20,1.0000,survsel1_phase)
   init_bounded_number srv3_sel95(40.0,200.0,survsel1_phase)
   init_bounded_number srv3_sel50(25.0,90.0,survsel1_phase)
   init_bounded_vector srv3_q_f(1988,endyr,0.20,1.0000,survsel1_phase)
   //init_bounded_number srv3_q_f(0.99999,1.0000,-survsel1_phase)
...
//model 5 estimate M
	...
	init_bounded_dev_vector m_dev_m(styr,endyr,-3,3,natM_phase)
	init_bounded_dev_vector m_dev_f(styr,endyr,-3,3,natM_phase)
...
////end of estimated parameters///////////////
 ...
 //Selectivity related variables
  ...
  3darray sel_srv3(1,2,1988,endyr+Nproj,1,nlenm)
 ...
 4darray Ftot(1,2,1,2,styr,endyr+Nproj,1,nlenm)
  ...
  vector offset_srv10(1,2)
   ...
   vector Fout(1,32)
   number call_no
   vector M_matn_mu(1,2)
   vector M_mato_mu(1,2)
    matrix M_matn(1,2,styr,endyr+Nproj)
    matrix M_mato(1,2,styr,endyr+Nproj)
    vector M(1,2)
